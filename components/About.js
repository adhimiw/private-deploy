function About() {
  try {
    ...
    const stats = [
      ...
      { number: '15+', label: 'States Covered', icon: 'map' },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-[var(--text-secondary)] leading-relaxed">
                <strong>VARMAN CONSTRUCTIONS</strong>, established in 2020, has rapidly grown to become a trusted supplier of premium building materials across India. Despite being a relatively new player in the market, our commitment to quality and customer satisfaction has helped us serve over 500+ construction projects successfully.
              </p>
              
              <p className="text-[var(--text-secondary)] leading-relaxed">
                We specialize in supplying high-quality construction materials including M-Sand, Blue Metal (Jalli), various types of bricks, cement, AAC blocks, and natural stones. Our extensive network now covers 15+ states with a primary focus on South Indian markets, ensuring that quality construction materials reach every corner of our service area.
              </p>
              ...
              <div className="absolute bottom-6 left-6 bg-white p-4 rounded-lg shadow-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-[var(--text-secondary)]">500+ Projects</div>
                  </div>
                </div>
              </div>
            </div>
