function Footer() {
  try {
    ...
    return (
      <footer className="deferred-section bg-dark-secondary text-white border-t border-[var(--border-color)]" data-name="footer" data-file="components/Footer.js">
            ...
            <div className="md:col-span-2">
              <div className="flex items-center space-x-3 mb-6 group">
                <img
                  ...
                  className="h-24 w-24 object-contain transition-all duration-500 group-hover:scale-105"
                  loading="lazy"
                  decoding="async"
                />
                <div>
            ...
            <div className="grid md:grid-cols-2 gap-4 items-center">
              <div>
                <p className="text-gray-300 text-sm">
                  Copyright {currentYear} VARMAN CONSTRUCTIONS. All rights reserved. Building Tamil Nadu with quality materials.
                </p>
              </div>
