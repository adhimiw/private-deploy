        ...
        <div className="max-w-full relative z-10 px-4 md:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 md:h-20 lg:h-24">
            ...
            <nav className="hidden lg:flex items-center space-x-1 flex-1">
              <button onClick={() => scrollToSection('home')} className="px-4 py-2 text-gray-700 hover:text-[var(--primary-color)] transition-all duration-300 font-medium">
                Home
              </button>
              <button onClick={() => scrollToSection('services')} className="px-4 py-2 text-gray-700 hover:text-[var(--primary-color)] transition-all duration-300 font-medium">
                Products
              </button>
              <button onClick={() => scrollToSection('about')} className="px-4 py-2 text-gray-700 hover:text-[var(--primary-color)] transition-all duration-300 font-medium">
                About
              </button>
            </nav>
            ...
            <div className="hidden lg:flex items-center space-x-1 flex-1 justify-end">
              <button onClick={() => scrollToSection('faq')} className="px-4 py-2 text-gray-700 hover:text-[var(--primary-color)] transition-all duration-300 font-medium">
                FAQ
              </button>
              <button onClick={() => scrollToSection('contact')} className="px-4 py-2 text-gray-700 hover:text-[var(--primary-color)] transition-all duration-300 font-medium">
                Contact
              </button>
