          ...
          <div className="flex items-center justify-between h-20 md:h-24">
            ...
            <div className="flex items-center space-x-3 group">
              <img
                ...
                className="h-16 md:h-20 lg:h-22 w-auto object-contain transition-all duration-500 group-hover:scale-105 drop-shadow-lg"
              />
              <div>
            ...
            <div className="hidden md:flex items-center space-x-4">
              <div className="text-right leading-tight">
                <a href="tel:+917708484811" className="block text-base font-semibold tracking-wide text-[var(--text-primary)] hover:text-[var(--primary-color)] transition-colors">
                  +91 77084 84811
                </a>
                <div className="text-xs text-[var(--text-secondary)] tracking-wider">
                  GSTIN:&nbsp;
                  <span className="font-semibold text-[var(--primary-color)]">33BTGPM9877H1Z3</span>
                </div>
              </div>
