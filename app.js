var VARMAN_PRIMARY_PHONE = '+917708484811';
var VARMAN_WHATSAPP_NUMBER = '917708484811';
var VARMAN_CONTACT_EMAIL = 'info@varmanconstructions.in';
...
function openMailTo(email, options) {
  if (!email) {
    return null;
  }
...
var VarmanSite = window.VarmanSite || {};
VarmanSite.primaryPhone = VARMAN_PRIMARY_PHONE;
VarmanSite.whatsappNumber = VARMAN_WHATSAPP_NUMBER;
VarmanSite.contactEmail = VARMAN_CONTACT_EMAIL;
VarmanSite.buildWhatsAppUrl = buildWhatsAppUrl;
VarmanSite.openExternalUrl = openExternalUrl;
VarmanSite.isMobileDevice = isMobileDevice;
VarmanSite.openMailTo = openMailTo;
VarmanSite.openWhatsApp = function openWhatsApp(message, target, number) {
